...
public class RegistrationActivity extends AppCompatActivity
{
    ...
    protected void onStart() {
        ...
        {
            Intent mainIntent=new Intent(RegistrationActivity.this, ContactsActivity.class);
    ...
    {
        Intent registerationActivity =new Intent(RegistrationActivity.this, ContactsActivity.class);
        startActivity(registerationActivity);
        finish();
    }
}
